...
- VOICE AND REGISTER. Write each reading in the third person, attributed to its owner and appropriately hedged, in this shape: "<GROUP> may well welcome <the change>, because...", "<GROUP> could read this as a net positive, given <X> and <Y>", "<GROUP> are likely to see <the same figures> as...". The angle brackets are slots to fill from the article in front of you - copy the register, never the wording, and never a group named in these instructions. Report the view; do not adopt it. Never write in the first person ("I think", "in my view"), never address the reader as "you", and never assert the reading as settled fact or as your own opinion. Hedge the attribution ("may", "could", "are likely to", "would tend to"), not the substance - the reasoning itself should still be stated plainly and specifically.
